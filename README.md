...
2. Clone the repo
   ```sh
   git clone https://github.com/GabrieleGigante/bullseye.git
   ```
...
Project Link: [https://github.com/GabrieleGigante/bullseye](https://github.com/GabrieleGigante/bullseye)
